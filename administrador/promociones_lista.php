...
<!DOCTYPE html>
                    ...
                    $.ajax({
                        ...
                        success : function(res) {
                            if (res.error) {
                                ...
                                window.location.href = 'ver_detalle_promocion.php?id=' + encodeURIComponent(id) + 
                    ...
                    $.ajax({
                        ...
                        success : function(res) {
                            ...
                            if (res.error) {
                                ...
                                // Redirigimos a la página de edición, pasando la información por la URL
                                window.location.href = 'promociones_modifica.php?id=' + encodeURIComponent(id) + 
                                                        '&nombre=' + encodeURIComponent(res.nombre) +
                                                        '&archivo=' + encodeURIComponent(res.archivo);
                            }
                        },  
    ...
    <body>
        ...
        <div class="detalle-contenedor">
            <h1 style="margin-bottom: 40px;">Listado de promociones (<?php echo $num; ?>)</h1>
            <div class="botones">
                <a href="promociones_alta.php">Dar de alta</a>
            </div>
            <div class="tabla">
